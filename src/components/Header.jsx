...
export function Header() {
  const { inputData, setInputData, quantityDataByPage, setQuantityDataByPage } =
    useContext(DadosContext);

  return (
    <header className="p-container-mobile md:px-container-desktop w-full  flex flex-col ">
      <div className="top w-full min-h-[4rem]  flex flex-col md:flex-row p-4 py-6 items-center justify-between  border-opacity-20">
        <div className="flex flex-1 w-full justify-between">
          ...
          <div className="flex gap-4 items-center ml-20 md:hidden">
            <button className="flex w-full max-w-[8rem]  p-2 justify-center items-center text-xl gap-2 bg-gradient-to-b from-primary-purple to-dark-purple rounded-lg hover:scale-95 transition-transform">
              Novo <Plus size={14} />
            </button>
